        ...
        <section class="content">
            ...
            <div class="container">
                <div class="card-header">
                    <h2 class="text-center">Data Rute</h2>
                    ...
                    @endif
                    <a href="/DataRuteCreate">
                        <tr><button type="button" class="btn btn-primary btn-sm">Create +</button></tr>
                    </a>
                    <a href="/DataRutePDF" target="_blank"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                            </ion-icon>
                        </button></a>
                    <div class="card-tools">
                        <form action="/DataRute" method="GET">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($data_rute as $data)
                            <tr>
                                <th scope="data">{{ $data->id_rute }}</th>
                                <td>{{ $data->nama_rute }}</td>
                                <td>{{ $data->jarak_rute }}</td>
                                <td>
                                    <a href="/DataRuteDelete/{{ $data->id_rute }}"
                                        class="btn btn-danger btn-sm">Delete</a>
                                    <a href="/DataRuteEdit/{{ $data->id_rute }}"
                ...
                {!! $data_rute->links('pagination::bootstrap-5') !!}
            </div>
        </section>
        <!-- /.content -->
    </div>
