    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Jadwal Pengiriman</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="container">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Data Jadwal Pengiriman</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/DataJadwalPengirimanUpdate/{{$data_jadwal_pengiriman->id_jadwal}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Id Jadwal</label>
                                <input type="text" name="id_jadwal" class="form-control" id="id_jadwal"
                                    placeholder="Edit Id Jadwal" value="{{$data_jadwal_pengiriman->id_jadwal}}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" name="hari_pengiriman" class="form-control" id="hari_pengiriman"
                                    placeholder="Edit Hari Pengiriman" value="{{$data_jadwal_pengiriman->hari_pengiriman}}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="time" name="jam_pengiriman" class="form-control" id="jam_pengiriman"
                                    placeholder="Edit Jam Pengiriman" value="{{$data_jadwal_pengiriman->jam_pengiriman}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select type="custom-select" name="id_pengiriman" class="custom-select"
                                    ...
                                    <option value="{{ $data->id_pengiriman }}"
                                        {{ $data->id_pengiriman == $data_jadwal_pengiriman->id_pengiriman ? 'selected' : '' }}>
