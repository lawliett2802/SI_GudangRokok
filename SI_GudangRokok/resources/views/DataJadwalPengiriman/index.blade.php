        ...
        <section class="content">
            ...
            <div class="container">
                <div class="card-header">
                    <h2 class="text-center">Data Jadwal Pengiriman</h2>
                    ...
                    @endif
                    <a href="/DataJadwalPengirimanCreate">
                        <tr><button type="button" class="btn btn-primary btn-sm">Create +</button></tr>
                    </a>
                    <a href="/DataJadwalPengirimanPDF" target="_blank"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon
                                name="print-outline">
                            </ion-icon>
                        </button></a>
                    <div class="card-tools">
                        <form action="/DataJadwalPengiriman" method="GET">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Hari Pengiriman</th>
                    ...
                    <tbody>
                        @foreach ($data_jadwal_pengiriman as $data)
                            <tr>
                                <th scope="data">{{ $data->id_jadwal }}</th>
                                ...
                                <td>
                                    <a href="/DataJadwalPengirimanDelete/{{ $data->id_jadwal }}"
                                        class="btn btn-danger btn-sm">Delete</a>
                                    <a href="/DataJadwalPengirimanEdit/{{ $data->id_jadwal }}"
                ...
                {!! $data_jadwal_pengiriman->links('pagination::bootstrap-5') !!}
            </div>
        </section>
        <!-- /.content -->
    </div>
