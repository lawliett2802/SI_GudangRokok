            ...
            <div class="container">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Input Data Gudang Rokok</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/DataGudangRokokInsert" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="id_gudang_rokok" class="form-control" id="id_gudang_Rokok"
                                    placeholder="Input ID Gudang Rokok">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kapasitas_gudang" class="form-control" id="kapasitas_gudang"
                                    placeholder="Input Kapasitas Gudang Rokok">
                            </div>
                            <!-- /.card-body -->
