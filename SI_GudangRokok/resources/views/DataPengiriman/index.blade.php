        ...
        <section class="content">
            ...
            <div class="container">
                <div class="card-header">
                    ...
                    @endif
                    <a href="/DataPengirimanCreate">
                        <tr><button type="button" class="btn btn-primary btn-sm">Create +</button></tr>
                    </a>
                    <a href="/DataPengirimanPDF" target="_blank"><button type="button" class="btn btn-secondary btn-sm">Print <ion-icon name="print-outline">
                            </ion-icon>
                        </button></a>
                    <div class="card-tools">
                        <form action="/DataPengiriman" method="GET">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($data_pengiriman as $data)
                            <tr>
                                <th scope="data">{{ $data->id_pengiriman }}</th>
                                ...
                                <td>
                                    <a href="/DataPengirimanDelete/{{ $data->id_pengiriman }}"
                                        class="btn btn-danger btn-sm">Delete</a>
                                    <a href="/DataPengirimanEdit/{{ $data->id_pengiriman }}"
                ...
                {!! $data_pengiriman->links('pagination::bootstrap-5') !!}
            </div>
        </section>
        <!-- /.content -->
    </div>
