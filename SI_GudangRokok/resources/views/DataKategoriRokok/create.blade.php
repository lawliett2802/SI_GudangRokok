    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Input Data Kategori Gudang Rokok</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="container">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Input Data Kategori Gudang Rokok</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/DataKategoriRokokInsert" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="id_kategori_rokok" class="form-control" id="id_kategori_Rokok"
                                    placeholder="Input Id kategori Rokok">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kategori_Rokok" class="form-control" id="nama_kategori_rokok"
                                    placeholder="Input Nama Kategori Rokok">
                            </div>
                            <!-- /.card-body -->
